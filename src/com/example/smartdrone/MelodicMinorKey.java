...
public class MelodicMinorKey extends AbstractKey {
    /**
     ...
     */
    public MelodicMinorKey(int keyCenterIx, NoteCollection noteCollection) {
     ...
     * @param       keyCenterIx int; index of key center.
     */
    public MelodicMinorKey(int keyCenterIx) {
        super(keyCenterIx);
    }
    ...
    protected void inflateKeyNotes(NoteCollection noteCollection) {
        ...
        if (noteCollection != null) {
            for (int i = 0; i < MusicTheory.DIATONIC_SCALE_SIZE; i++) {
                offset = MusicTheory.MELODIC_MINOR_SCALE_SEQUENCE[i];
